...
insert into manufacturer (manufacturer_id, name, location_id, average_Yearly_Sales, founded_Date) values (1, 'Fender Musical Instruments Corporation', 3, 25000000, '1946-01-01');
insert into manufacturer (manufacturer_id, name, location_id, average_Yearly_Sales, founded_Date) values (2, 'Gibson Guitar Corporation', 42, 32000000, '1902-01-01');
